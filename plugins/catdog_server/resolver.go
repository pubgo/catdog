...
// Translates /foo/bar/zool into api catdog_service go.micro.api.foo method Bar.Zool
// Translates /foo/bar into api catdog_service go.micro.api.foo method Foo.Bar
func apiRoute(p string) (string, string) {
	...
	// Use first part as catdog_service
	...
	// /v1/foo/bar => catdog_service: v1.foo method: Foo.bar
